...
public class Config {
	...
	static String WINDOW_TITLE = "Voidscape"; // Only set here due to config not set by server fast enough at load time
	...
	public static final int CLIENT_VERSION = 10120;
	...
	public static boolean S_WANT_CUSTOM_LANDSCAPE = true;

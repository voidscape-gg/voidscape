...
|---|---:|---:|---|
| Client version | `10122` | `10122` until next client-visible change | Must match `Client_Base/src/orsc/Config.java`. |
...
| `client_version` | `10122` | Match client | Match client | Server conf + `Config.java` |

...
- [ ] Android, if shipping APK: touch movement, long-press menu, login/chat keyboard, inventory, bank scrolling, camera rotate, zoom, background/resume, logout, portrait gameplay framing, and settings-panel spacing are smoke-tested.

...
- `GET /state` returns a JSON snapshot of client state: game dimensions/state, mouse state, local player basics when logged in, and selected interface state for the Auction House, world map, native shop window, bank, and bestiary.

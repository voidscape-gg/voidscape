...
- `server/src/com/openrsc/server/content/PlayerTitle.java` is the title registry. It contains the 100-title catalog, requirement metadata, cache keys, lookup helpers, and automatic unlock checks.
...
- `::titles count` shows the player's unlocked count out of the 100-title catalog.

...
The mobile login account/recovery buttons default to the same web root:
  ...
  Recover account -> /#security
Override when needed:
  index.html?mobile=1&portal=https://<portal-host>/
  index.html?mobile=1&portalAccountUrl=https://<portal-host>/#account&portalRecoveryUrl=https://<portal-host>/recover
...
or:
  https://<host>/index.html?mobile=1&portalAccountUrl=https://<portal-host>/#account&portalRecoveryUrl=https://<portal-host>/recover

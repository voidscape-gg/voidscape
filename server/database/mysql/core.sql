...
DROP TABLE IF EXISTS `bestiaryloot`;
...
DROP TABLE IF EXISTS `voidarena_ranked_stats`;
...
DROP TABLE IF EXISTS `voidarena_ranked_matches`;
...
DROP TABLE IF EXISTS `voidarena_ranked_match_sessions`;
CREATE TABLE IF NOT EXISTS `voidarena_ranked_match_sessions`
(
    ...
    KEY `voidarena_sessions_season_end` (`season_id`, `ended_at_ms`, `match_id`),
    KEY `voidarena_sessions_status_start` (`status`, `started_at_ms`),
    KEY `voidarena_sessions_pair_end` (`player_a_id`, `player_b_id`, `ended_at_ms`),
    KEY `voidarena_sessions_player_a` (`player_a_id`, `season_id`, `ended_at_ms`),
    KEY `voidarena_sessions_player_b` (`player_b_id`, `season_id`, `ended_at_ms`),
...
DROP TABLE IF EXISTS `duel_proof_witnesses`;
DROP TABLE IF EXISTS `duel_proof_attempt_participants`;
DROP TABLE IF EXISTS `duel_proof_attempts`;
DROP TABLE IF EXISTS `duel_receipt_swings`;
DROP TABLE IF EXISTS `duel_receipt_stakes`;
DROP TABLE IF EXISTS `duel_receipt_participants`;
DROP TABLE IF EXISTS `duel_receipts`;
CREATE TABLE IF NOT EXISTS `duel_receipts`
(
...
CREATE TABLE IF NOT EXISTS `duel_receipt_participants`
(
...
CREATE TABLE IF NOT EXISTS `duel_receipt_stakes`
(
    `duel_id`         bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `duel_receipt_swings`
(
    `duel_id`         bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `duel_proof_attempts`
(
...
CREATE TABLE IF NOT EXISTS `duel_proof_attempt_participants`
(
    `proof_id`           char(32) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `duel_proof_witnesses`
(
    `proof_id`         char(32) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
...
(
    ...
    `topcolour`         int(5) UNSIGNED              DEFAULT 15,
    `trousercolour`     int(5) UNSIGNED              DEFAULT 22,
    `skincolour`        int(5) UNSIGNED              DEFAULT 43,
...
DROP TABLE IF EXISTS `item_provenance_events`;

...
public final class Constants {
	 ...
	 */
	public final static int characterSkinColours[] = {
		...
		0xF2C8BA, 0xD99A8F, 0xA76A45, 0x6D3F2C,
		0x9B9290
	};
	/**
	 * Allowable character hair colours
	 */
	public final static int characterHairColours[] = {
	 ...
	 */
	public final static int characterTopBottomColours[] = {
	...
	public static final Map<Spells, Integer> spellMap = new HashMap<Spells, Integer>() {{
		put(Spells.HOME_TELEPORT, 0);
		put(Spells.WIND_STRIKE, 1);
		put(Spells.CONFUSE, 2);
		put(Spells.WATER_STRIKE, 3);
		put(Spells.ENCHANT_LVL1_AMULET, 4);
		put(Spells.EARTH_STRIKE, 5);
		put(Spells.WEAKEN, 6);
		put(Spells.FIRE_STRIKE, 7);
		put(Spells.BONES_TO_BANANAS, 8);
		put(Spells.WIND_BOLT, 9);
		put(Spells.CURSE, 10);
		put(Spells.LOW_LEVEL_ALCHEMY, 11);
		put(Spells.WATER_BOLT, 12);
		put(Spells.VARROCK_TELEPORT, 13);
		put(Spells.ENCHANT_LVL2_AMULET, 14);
		put(Spells.EARTH_BOLT, 15);
		put(Spells.LUMBRIDGE_TELEPORT, 16);
		put(Spells.TELEKINETIC_GRAB, 17);
		put(Spells.FIRE_BOLT, 18);
		put(Spells.FALADOR_TELEPORT, 19);
		put(Spells.CRUMBLE_UNDEAD, 20);
		put(Spells.WIND_BLAST, 21);
		put(Spells.SUPERHEAT_ITEM, 22);
		put(Spells.CAMELOT_TELEPORT, 23);
		put(Spells.WATER_BLAST, 24);
		put(Spells.ENCHANT_LVL3_AMULET, 25);
		put(Spells.IBAN_BLAST, 26);
		put(Spells.ARDOUGNE_TELEPORT, 27);
		put(Spells.EARTH_BLAST, 28);
		put(Spells.HIGH_LEVEL_ALCHEMY, 29);
		put(Spells.CHARGE_WATER_ORB, 30);
		put(Spells.ENCHANT_LVL4_AMULET, 31);
		put(Spells.WATCHTOWER_TELEPORT, 32);
		put(Spells.FIRE_BLAST, 33);
		put(Spells.CLAWS_OF_GUTHIX, 34);
		put(Spells.SARADOMIN_STRIKE, 35);
		put(Spells.FLAMES_OF_ZAMORAK, 36);
		put(Spells.CHARGE_EARTH_ORB, 37);
		put(Spells.WIND_WAVE, 38);
		put(Spells.CHARGE_FIRE_ORB, 39);
		put(Spells.WATER_WAVE, 40);
		put(Spells.CHARGE_AIR_ORB, 41);
		put(Spells.VULNERABILITY, 42);
		put(Spells.ENCHANT_LVL5_AMULET, 43);
		put(Spells.EARTH_WAVE, 44);
		put(Spells.ENFEEBLE, 45);
		put(Spells.FIRE_WAVE, 46);
		put(Spells.STUN, 47);
		put(Spells.CHARGE, 48);
	}};

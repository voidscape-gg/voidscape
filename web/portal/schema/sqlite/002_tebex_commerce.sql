...
-- This ledger intentionally contains no customer email, username, IP address, or
-- raw webhook body.  The opaque intent binds a portal account to one allowlisted
-- package while the provider transaction id remains restricted provenance data.
